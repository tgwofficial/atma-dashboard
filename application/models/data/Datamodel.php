...
class Datamodel extends CI_Model {
    ...
    public function get_data_ibu($locations){  
        ...
        $ibus = $this->db->query("SELECT data_identitas_ibu.name as nama, data_identitas_ibu.unique_id as uniqueid, data_identitas_ibu.dusun as dusunasal,data_identitas_ibu.telp as telpon, data_identitas_ibu.*, data_rencana_persalinan.*, data_status_persalinan.*, data_transportasi.*, data_close_ibu.alasan, STR_TO_DATE(data_status_persalinan.tgl_persalinan, '%d-%m-%Y') as tgl_persalinan FROM data_identitas_ibu LEFT JOIN data_rencana_persalinan ON data_identitas_ibu.unique_id=data_rencana_persalinan.id_ibu LEFT JOIN data_status_persalinan ON data_identitas_ibu.unique_id=data_status_persalinan.id_ibu LEFT JOIN data_transportasi ON data_rencana_persalinan.id_trans=data_transportasi.unique_id LEFT JOIN data_close_ibu ON data_identitas_ibu.unique_id=data_close_ibu.unique_id WHERE (data_close_ibu.alasan IS NULL or data_close_ibu.alasan = 'nifas berakhir')
